...
def clear_data():
    ...
    with app.app_context():
        ...
        print("\n[1/4] 清空作业版本表...")
        try:
            version_count = db.session.query(HomeworkVersion).count()
            db.session.query(HomeworkVersion).delete()
            db.session.commit()
            print(f"[OK] 已删除 {version_count} 个作业版本记录")
        ...
        print("\n[2/4] 清空作业表...")
        try:
            homework_count = db.session.query(Homework).count()
            db.session.query(Homework).delete()
            db.session.commit()
            print(f"[OK] 已删除 {homework_count} 个作业记录")
        except Exception as e:
        ...
        print("\n[3/4] 清空作业类型表...")
        try:
            type_count = db.session.query(HomeworkType).count()
            db.session.query(HomeworkType).delete()
            db.session.commit()
            print(f"[OK] 已删除 {type_count} 个作业类型记录")
        except Exception as e:
        ...
        try:
            ...
            db.session.commit()
            print(f"[OK] 已删除 {course_count} 个课程记录")
        except Exception as e:
