"""
创建1条优秀作业测试数据（使用 test_two.docx，包含自动转换）
"""
...
def create_excellent_homework():
    ...
    with app.app_context():
        print("=" * 60)
        print("开始创建1条优秀作业测试数据（使用 test_two.docx）")
        print("=" * 60)
        ...
        # 4. 上传原始文件（test_two.docx）
        print("\n[4/7] 上传原始Office文档（test_two.docx）...")
        docx_path = 'img/test_two.docx'
        ...
        # 创建文件记录
        file_record = File(
            filename='test_two.docx',
            original_filename='test_two.docx',
            file_path=docx_path,
            ...
            try:
                ...
                if pdf_path and os.path.exists(pdf_path):
                    ...
                    pdf_file_record = File(
                        ...
                        original_filename='test_two.pdf',
                        file_path=pdf_path,
                        ...
                        try:
                            ...
                            if image_path and os.path.exists(image_path):
                                ...
                                image_file_record = File(
                                    ...
                                    original_filename='test_two_preview.jpg',
        ...
        print(f"  文件名: {file_record.original_filename}")
        if pdf_file_id:
...
if __name__ == '__main__':
    print("=" * 60)
    print("优秀作业测试数据创建工具（使用 test_two.docx）")
    print("=" * 60)
    print()
    print("[INFO] 此操作将创建：")
    print("  - 1条优秀作业记录（使用 test_two.docx）")
    print("  - 自动将 test_two.docx 转换为 PDF")
